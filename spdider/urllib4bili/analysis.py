...
fpath = r'./urllib4bili/data/全站榜.全站.全部投稿.日排行/20200305'
...
# 分离变量与因变量，并归一化
keys = dat.columns
var_data = dat[keys[:-2]].copy()
# print("var_data is:\n")
# print(var_data.head())
# print(var_data.describe())
score = dat[keys[-2]].copy()
# print("score is:\n")
# print(score.head())
